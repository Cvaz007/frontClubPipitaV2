...
const rutas = [
    ...
    /*RUTAS DEL REGISTRAR*/
    // { path: '/RegistrarTorneo', component: FRMRegistrarTorneo, exact: true },
    // { path: '/RegistrarJugador', component: FRMRegistrarJugador, exact: true },
    // { path: '/RegistrarEquipo', component: FRMRegistrarEquipo, exact: true }
